...
def main():
    ...
    # Q3 (조건에 따라 다른 질문과 옵션을 표시, 항상 Q3는 표시됨)
    if q1 == "학생들의 창의력과 미래 대비 능력 개발":
        if q2 == "학생들이 직접 문제를 탐구하는 프로젝트 제공":
            q3_options = [
                "디자인 씽킹으로 문제 해결 연습",
                "학생 주도 프로젝트 설계",
                "AI 도구를 활용한 창의적 사고 강화"
            ]
            q3_question = "Q3. 창의적 사고를 증진하기 위해 가장 효과적인 방법은 무엇이라고 생각하십니까?"
        elif q2 == "창의적 사고를 자극하는 도구 활용":
            q3_options = [
                "온라인 플랫폼 활용",
                "3D 프린터와 같은 메이커 도구 활용",
                "AR/VR 등 디지털 기술 활용"
            ]
            q3_question = "Q3. 창의적 사고를 돕기 위한 도구 중 가장 효과적이라고 생각되는 것은 무엇입니까?"
        elif q2 == "팀 기반 창의적 문제 해결":
            q3_options = [
                "팀워크를 강화하는 프로젝트",
                "창의적 아이디어를 공유하는 워크숍",
                "온라인 협업 도구 활용"
            ]
            q3_question = "Q3. 협업을 통해 창의력을 높이기 위한 최적의 방법은 무엇입니까?"
        else:
            q3_options = ["N/A"]
            q3_question = "Q3. 추가 질문이 필요하지 않습니다."

    elif q1 == "학생들의 정서적 성장과 행복 증진":
        if q2 == "학생들과 정기적으로 대화하기":
            q3_options = [
                "감정일기 쓰기 활동",
                "학생들과 개별 면담 시간 운영",
                "정기적인 상담 프로그램 마련"
            ]
            q3_question = "Q3. 정서적 성장을 위해 가장 효과적인 방법은 무엇입니까?"
        elif q2 == "감정 표현을 위한 활동 제공":
            q3_options = [
                "미술 활동(그림일기 등) 활용",
                "음악 치료 및 연극 활동",
                "롤플레이를 통한 감정 표현 연습"
            ]
            q3_question = "Q3. 감정 표현 활동 중 가장 선호하는 방법은 무엇입니까?"
        elif q2 == "정서적 안정 프로그램 도입":
            q3_options = [
                "마음챙김 명상 프로그램",
                "학교 상담 프로그램 활용",
                "긍정 심리학 기반 프로그램 도입"
            ]
            q3_question = "Q3. 정서적 안정을 위해 가장 효과적인 프로그램은 무엇입니까?"
        else:
            q3_options = ["N/A"]
            q3_question = "Q3. 추가 질문이 필요하지 않습니다."
        ...
        if q2 == "최신 기술과 도구 학습":
            ...
            q3_question = "Q3. 전문성을 높이기 위한 가장 효과적인 방법은 무엇입니까?"
        elif q2 == "교사 간 협업과 연구":
            q3_options = [
                "공동 프로젝트 설계 및 운영",
                "교사 간 학습 공동체 운영",
            ...
            q3_question = "Q3. 교사 간 협업을 활성화하기 위한 방법은 무엇입니까?"
        elif q2 == "전문적인 컨퍼런스 참여":
            q3_options = [
                "국내 워크숍 참석",
                "국제 교육 컨퍼런스 참여",
                "온·오프라인 학습 병행"
            ]
            q3_question = "Q3. 워크숍이나 컨퍼런스를 통해 얻을 수 있는 효과는 무엇입니까?"
        else:
            q3_options = ["N/A"]
            q3_question = "Q3. 추가 질문이 필요하지 않습니다."
        ...
        if q2 == "정기적인 피드백 제공":
            ...
            q3_question = "Q3. 학업 성취도를 높이기 위해 가장 필요한 피드백 방법은 무엇입니까?"
        elif q2 == "데이터 기반 학습 분석":
            q3_options = [
                "학생 데이터 시각화",
                "학습 성과를 점검하는 주간 리포트",
                "학습 맞춤형 데이터 활용"
            ]
            q3_question = "Q3. 데이터 활용을 통한 학습 성과 향상의 효과는 무엇입니까?"
        elif q2 == "개별 학습 계획 수립":
            q3_options = [
                "학생 진도 관리 체크리스트 작성",
                "학생과의 상담을 통한 계획 설계",
            ...
            q3_question = "Q3. 개별 학습 계획을 효과적으로 세우는 방법은 무엇입니까?"
        else:
            q3_options = ["N/A"]
            q3_question = "Q3. 추가 질문이 필요하지 않습니다."
...
**추천 도구/접근법:**  
- Google Forms, LMS 플랫폼 등 평가 및 피드백 관리 도구  
- 데이터 시각화 툴 활용한 학습현황 분석  
